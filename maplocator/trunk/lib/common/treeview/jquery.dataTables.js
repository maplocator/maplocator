...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			/*
			 * Variable: anLengthMenu
			 * Purpose:  The options avialable for showing number of entries
			 * Scope:    jQuery.dataTable.classSettings
			 */
			this.anLengthMenu = new Array(10, 20, 50, 100);
		}
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			//			for(var i in oSettings.anLengthMenu) {
			var len = oSettings.anLengthMenu.length;
                        for (var i = 0; i < len; i++) {
				var lnth = oSettings.anLengthMenu[i];
				sStdMenu += '<option value="'+lnth+'">'+lnth+'</option>';
			}
			sStdMenu += '</select>';
		...
		return this.each(function()
		{
			...
			if ( typeof oInit != 'undefined' && oInit != null )
			{
				...
				if ( typeof oInit.anLengthMenu != 'undefined' ) {
					oSettings.anLengthMenu = oInit.anLengthMenu;
					oSettings.iDisplayLength = oSettings.anLengthMenu[0];
                }
